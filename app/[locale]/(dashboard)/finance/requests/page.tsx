// Full org-wide list of payment requests. Filter by status, category,
// site, and free-text on description/payee. Everyone can view; only
// finance roles get approve / reject / mark-paid actions inside the
// list component (`canSettle` prop).
